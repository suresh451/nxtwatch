            ...
            return(
                <div>
                    ...
                    <div>
                        ...
                        <div>
                            <div>
                                <ButtonIcon type="button" color={isLiked ? '#3b82f6': '#475569'} onClick={clickLike}>
                                    <AiOutlineLike size={25} />
                                    <p>Like</p>
                                </ButtonIcon>
                            </div>
                            <div>
                                <ButtonIcon type="button" color={isDisLiked ? '#3b82f6': '#475569'} onClick={clickDisLike}>
